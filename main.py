...
Team Member 1: preprocessing.py, transforms.py, descriptors.py
Team Member 2: experiments.py, matching.py
"""
...
from experiments import (
    ...
    run_gaussian_noise, run_salt_pepper, run_erosion, run_dilation,
    # accuracy analysis
...
def phase4():
    ...
    print_summary_table(stats, per_dist)
